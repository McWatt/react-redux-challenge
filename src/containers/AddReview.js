...
class AddReview extends Component {
  ...
  handleAdd() {
    ...
    this.props.dispatch(doctorsAddReview(this.props.doctorId, fakeId));
  ...
  handleRemove() {
    this.props.dispatch(reviewsRemove(this.props.review.id));
  ...
  render() {
    ...
    return (
      <StyledFormContainer>
        ...
        {this.state.edit ? (
          <div>
            <Button onClick={this.handleRemove} danger large>
              Remove
            </Button>
            <Button onClick={this.handleUpdate} large>
              Update
            </Button>
          </div>
        ) : (
          <Button disabled={!isValid} onClick={this.handleAdd} next large>
            Add Review
          </Button>
        )}
      </StyledFormContainer>
